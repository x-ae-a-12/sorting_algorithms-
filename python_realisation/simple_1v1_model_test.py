...
class SorterCheck(unittest.TestCase):
    """
    Some tests to check simple sorting algorithm...
    """
    def test_ideal_case(self):
        sorter = Sorter()
        array = [7, 9, 5, 10, 6, 8, 4, 3, 2, 1]
        self.assertEqual(sorter._simple_1v1_model(array), sorted(array))
    ...
    def test_ideal_case_float(self):
        ...
        ans = np.array_equal(sorter._simple_1v1_model(array), sorted(array))
